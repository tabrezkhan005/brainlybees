      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="flex items-center flex-shrink-0">
            {/* BrainlyBees Logo - matching Kidway style */}
            <div className="flex items-center">
              <div className="w-8 h-8 bg-gradient-to-br from-red-500 via-orange-500 to-yellow-500 rounded-lg flex items-center justify-center mr-2 transform rotate-12">
                <div className="w-5 h-5 bg-white rounded-sm transform -rotate-12"></div>
              </div>
              <div>
                <div className="text-lg font-bold text-gray-800">BRAINLYBEES</div>
                <div className="text-xs text-gray-500 -mt-0.5">Think. Learn. Lead.</div>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-4 flex-shrink-0">
            ...
            <a
              href="https://wa.me/"
              className="hidden sm:flex items-center justify-center w-12 h-12 bg-green-500 rounded-full hover:bg-green-600 transition-colors duration-200"
            >
            ...
            <button className="bg-red-500 hover:bg-red-600 text-white px-8 py-3 rounded-full text-sm font-semibold transition-colors duration-200 shadow-sm whitespace-nowrap">
              Book Free Trial
            </button>
