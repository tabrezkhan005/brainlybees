      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-3 flex-shrink-0">
            ...
            <a
              href="https://wa.me/"
              className="hidden sm:flex items-center justify-center w-10 h-10 bg-green-500 rounded-full hover:bg-green-600 transition-colors duration-200"
            >
            ...
            <button className="bg-red-500 hover:bg-red-600 text-white px-6 py-2.5 rounded-full text-sm font-semibold transition-colors duration-200 shadow-sm">
              Book Free Trial
            </button>
        ...
        <div className="lg:hidden">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white border-t">
            ...
            <div className="px-3 py-2">
              <button className="w-full bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded-full text-sm font-medium transition-colors duration-200">
                Book Free Trial
              </button>
            </div>
          </div>
