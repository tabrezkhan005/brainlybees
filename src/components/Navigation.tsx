        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="flex items-center flex-shrink-0">
            <Link href="/" className="flex items-center space-x-3">
              ...
              <div>
                ...
                <div className="text-sm text-orange-600 -mt-1 font-nunito">Smart Learning for Kids</div>
              </div>
            </Link>
          </div>
          ...
          <div className="flex items-center space-x-4 flex-shrink-0">
            ...
            <button
              ...
              className="lg:hidden p-3 rounded-2xl text-gray-400 hover:text-orange-600 hover:bg-orange-50 transition-all duration-300"
            >
          ...
          <div className="px-4 pt-4 pb-6 space-y-2 bg-gradient-to-r from-orange-50 via-yellow-50 to-pink-50 backdrop-blur-lg border-t border-orange-100">
            ...
            <div className="px-4 py-4 space-y-4">
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="flex items-center justify-center w-full bg-gradient-to-r from-green-400 to-green-500 hover:from-green-500 hover:to-green-600 text-white px-6 py-4 rounded-2xl text-sm font-bold transition-all duration-300 shadow-lg font-poppins"
              >
